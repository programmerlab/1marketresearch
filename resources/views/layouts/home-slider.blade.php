<div class="intro-area banner-section">
    ...
    <div class="input-group-append">
        <a href="#">Search</a>
                ...
                </div></div><div class="owl-item active" style="width: 1472px; margin-right: 0px;"><div class="intro-content">
                    <div class="slider-images">
                        <img src="{{ asset('public/assets/img/slider/s1.jpg')}}" alt="">
                    </div>
                    <div class="slider-content">
    ...
    <div class="input-group-append">
        <a href="#">Search</a>
                ...
                </div></div><div class="owl-item" style="width: 1472px; margin-right: 0px;"><div class="intro-content">
                    <div class="slider-images">
    ...
    <div class="input-group-append">
        <a href="#">Search</a>
                ...
                </div></div></div></div><div class="owl-controls"><div class="owl-nav"><div class="owl-prev" style=""><i class="icon icon-chevron-left"></i></div><div class="owl-next" style=""><i class="icon icon-chevron-right"></i></div></div><div class="owl-dots" style="display: none;"></div></div></div>
