...
@section('content')
     <!-- header end -->
        ...
        <div class="published-date">
            <div class="row">
                <div class="date-box">
                  <div class="col-sm-12 border-right"> <span class="pub-date">"Quinoa Seed Market Report by Company, Regions, Types and Applications, Global Status and Forecast to 2025" has been added to your cart</span> </div>
